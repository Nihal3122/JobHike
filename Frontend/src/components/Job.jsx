...
const Job = ({ job }) => {
  ...
  return (
    <div className="p-5 rounded-md shadow-lg bg-white border transition hover:shadow-xl hover:border-gray-300 cursor-pointer">
      ...
      <div>
        ...
        <p className="text-sm text-gray-700 line-clamp-2 px-1 h-10">
          {job?.description}
        </p>
      </div>
